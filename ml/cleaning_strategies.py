"""
MLForge ML Engine - Data Cleaning & Normalization Strategies Module
...
class CleaningStrategy:
    """
    Data Cleaning & Normalization Strategies Engine.
    """
    ...
    def handle_outliers(
        ...
        """
        Detects and handles outliers via IQR bounds or Z-score thresholds (actions: 'clip', 'drop', 'nullify').
        """
        df_out = df.copy()
    ...
    def group_rare_categories(
        ...
        """
        Groups infrequent categorical values (< threshold %) into a unified 'Other' level.
        """
        df_grouped = df.copy()
