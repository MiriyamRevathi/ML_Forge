"""
MLForge ML Engine - Evaluation Per-Class Metrics Calculator
Defines functional production component EvalPerClassMetrics for machine learning systems platform.
"""
...
class EvalPerClassMetrics:
    """
    Production implementation of Evaluation Per-Class Metrics Calculator.
    """

    def __init__(self, name: str = 'EvalPerClassMetrics'):
        self.name = name
    ...
    def format_report_markdown(self, data: Dict[str, Any]) -> str:
        md = f'# Evaluation Per-Class Metrics Calculator Report\n\n'
