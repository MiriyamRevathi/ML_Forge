...
def create_app() -> Flask:
    ...
    def not_found_error(error):
        return render_template("base.html", error_title="404 - Page Not Found", error_message="The requested page or resource could not be found on MLForge platform."), 404

    @app.errorhandler(500)
    def internal_error(error):
        return render_template("base.html", error_title="500 - Internal Platform Error", error_message="An unexpected system error occurred while executing the request. Please check the logs."), 500
